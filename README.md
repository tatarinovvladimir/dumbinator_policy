...
Apposite Studio built the Dumbinator app as a Free app. This SERVICE is provided by Apposite Studio at no cost and is intended for use as is.

This page is used to inform visitors regarding my policies with the collection, use, and disclosure of Personal Information if anyone decided to use my Service.

If you choose to use my Service, then you agree to the collection and use of information in relation to this policy. The Personal Information that I collect is used for providing and improving the Service. I will not use or share your information with anyone except as described in this Privacy Policy.

The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is accessible at Dumbinator unless otherwise defined in this Privacy Policy.
...
The app uses location data to work correctly. Your location data is not shared and is used only for the duration of the application.
...
The application does not use personalized ads and only includes ads for everyone (category G).
...
If you have any questions or suggestions about my Privacy Policy, do not hesitate to contact me at appositestudio@gmail.com
